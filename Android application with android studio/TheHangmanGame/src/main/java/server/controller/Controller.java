...
public class Controller {
    ...
    /**
     * @see GameCalculations#getWord(ArrayList)
    ...
    /**
     * @see GameCalculations#guessLetter(String, String, char)
    ...
    /**
     * @see GameCalculations#guessWord(String, String)
    ...
    /**    
     * @see GameCalculations#hideWord(String)
    ...
    /**
     * @see GameCalculations#removeSpaces(String)
